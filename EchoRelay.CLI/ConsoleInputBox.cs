...
// thank you https://stackoverflow.com/a/31770761
public class ConsoleInputBox
{
    ...
    public ConsoleInputBox(short left, short top, short width, short height, Colors defaultForegroundColor = Colors.Gray, Colors defaultBackgroundColor = Colors.Black)
    {
    ...
    public void Write(string text, Colors fgColor, Colors bgColor)
    {
        var c = _defaultColor;
        _defaultColor = CombineColors(fgColor, bgColor);
        Write(text);
    ...
    public void Write(char[] text, Colors fgColor, Colors bgColor)
    {
        var c = _defaultColor;
        _defaultColor = CombineColors(fgColor, bgColor);
        Write(text);
